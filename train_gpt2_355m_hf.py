...
dataset = dataset.train_test_split(train_size=train_size, test_size=test_size + val_size, seed=42)
val_test = dataset["test"].train_test_split(train_size=val_size, test_size=test_size, seed=42)
