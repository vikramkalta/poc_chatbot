...
class CausalAttention(nn.Module):
  ...
  def forward(self, x):
    ...
    attn_scores.masked_fill_( # New, _ ops are in-place
      self.mask.bool()[:num_tokens, :num_tokens], -torch.inf) # :num_tokens to account for cases where the number of tokens in batch is smaller than the supported context size
